    ...
    this.chipWidth,
          ...
          builder: (FormFieldState<List<V>> state) {
            ...
            return _MultiSelectChipFieldView<V?>.withState(
              view as _MultiSelectChipFieldView<V?>,
              state,
            );
          },
        );
...
class _MultiSelectChipFieldView<V> extends StatefulWidget with MultiSelectActions {
  ...
  _MultiSelectChipFieldView.withState(
    _MultiSelectChipFieldView<V> field,
    FormFieldState<List<V>> this.state,
  )   : items = field.items,
        title = field.title,
          ...
          child: Column(
            children: [
              ...
              widget.scroll
                  ? Container(
                      padding:
                          widget.itemBuilder == null ? const EdgeInsets.symmetric(horizontal: 5) : null,
    ...
    return Container(
      ...
      child: ChoiceChip(
        ...
        selectedColor: widget.colorator != null && widget.colorator!(item.value) != null
            ? widget.colorator!(item.value)
            : widget.selectedChipColor ?? Theme.of(context).primaryColor.withOpacity(0.33),
        onSelected: (_) {
          if (_) {
